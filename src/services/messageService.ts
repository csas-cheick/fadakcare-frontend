      ...
      return [
        {
          ...
          destinataireId: this.getUserId(),
          contenu: 'Salut ! Comment ça va ?',
          dateEnvoi: new Date(Date.now() - 3600000).toISOString()
        },
        {
          id: 2,
          expediteurId: this.getUserId(),
          destinataireId: contactId,
          contenu: 'Ça va bien merci ! Et vous ?',
          dateEnvoi: new Date(Date.now() - 3300000).toISOString()
        },
        {
          id: 3,
          expediteurId: contactId,
          destinataireId: this.getUserId(),
          contenu: 'Parfait ! On se voit demain ?',
        ...
        },
        {
          ...
          expediteurId: this.getUserId(),
          destinataireId: contactId,
          contenu: 'Oui bien sûr, à 14h comme prévu 👍',
          dateEnvoi: new Date(Date.now() - 300000).toISOString()
        }
      ];
    }
  }
