...
function Header({ onClick, onToggle }: HeaderProps) {
  ...
  <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      ...
      title="Ouvrir le menu"
          ...
          <button
            onClick={onClick}
            aria-label="Basculer la navigation latérale"
          ...
          <button
            ...
            aria-label={isApplicationMenuOpen ? 'Fermer le menu applications' : 'Ouvrir le menu applications'}
            title={isApplicationMenuOpen ? 'Fermer les applications' : 'Applications'}
