  ...
  return (
    <div className="fixed z-50 bottom-6 right-6">
      <button
        type="button"
        onClick={toggleChat}
        className="relative group flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-primary to-teal-500 text-white shadow-lg hover:from-primary/90 hover:to-teal-500/80 transition active:scale-95 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/60"
      ...
      >
        {isOpen ? (
          ...
          <>
            <span className="absolute inset-0 rounded-full animate-ping-soft bg-primary/40" aria-hidden="true" />
      ...
      {isOpen && (
        ...
        >
          <div className="flex items-center justify-between gap-2 px-4 py-2.5 rounded-t-xl shadow-inner bg-gradient-to-r from-primary to-primary/70 dark:from-primary/90 dark:to-teal-600 relative after:pointer-events-none after:absolute after:inset-0 after:rounded-t-xl after:bg-black/0 dark:after:bg-black/10">
          ...
          >
            <input
              ref={inputRef}
              type="text"
              className="flex-1 rounded-l-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/60"
            ...
            <button
              ...
              className={`flex items-center justify-center rounded-r-md px-4 text-sm font-medium transition focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 ${
                input.trim() === "" || isTyping
