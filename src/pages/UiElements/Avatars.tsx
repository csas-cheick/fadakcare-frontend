...
export default function Avatars() {
  return (
    <>
      <PageMeta
  title="React.js Avatars Dashboard | FadakCare - React.js Admin Dashboard Template"
  description="This is React.js Avatars Dashboard page for FadakCare - React.js Tailwind CSS Admin Dashboard Template"
      />
