...
const MesPatientsPage: React.FC = () => {
  ...
  const getInitials = (name: string) => name.split(/\s+/).filter(Boolean).map(n => n[0]).slice(0, 2).join('').toUpperCase();
                ...
                {paginatedPatients.map(patient => (
                  ...
                  >
                    <div className="flex items-center space-x-4 mb-4">
                      <div className="h-14 w-14 rounded-full bg-gradient-to-r from-teal-500 to-cyan-600 flex items-center justify-center text-white text-lg font-semibold">
